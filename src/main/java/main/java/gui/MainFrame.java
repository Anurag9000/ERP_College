...
public class MainFrame extends JFrame {
    ...
    private CatalogManagementPanel catalogManagementPanel;
    ...
    private RegistrationApprovalPanel registrationApprovalPanel;
    ...
    private void initializePanelsForRole() {
        ...
        if ("Student".equalsIgnoreCase(role)) {
            ...
            catalogManagementPanel = new CatalogManagementPanel(currentUser);
            ...
            registrationApprovalPanel = new RegistrationApprovalPanel(currentUser);
    ...
    private void addRoleSpecificTabs() {
        ...
        if ("Student".equalsIgnoreCase(role)) {
            ...
            tabbedPane.addTab("Catalog", createTabIcon("📖"), catalogManagementPanel);
            ...
            tabbedPane.addTab("Reg Approvals", createTabIcon("📝"), registrationApprovalPanel);
